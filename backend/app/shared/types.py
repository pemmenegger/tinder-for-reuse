...
class WasteCodeType:
    ...
    _170101 = UnifiedType(id=1, discriminator=DISCRIMINATOR, value="17 01 01")
    _170102 = UnifiedType(id=2, discriminator=DISCRIMINATOR, value="17 01 02")
    _170103 = UnifiedType(id=3, discriminator=DISCRIMINATOR, value="17 01 03")
    _170106 = UnifiedType(id=4, discriminator=DISCRIMINATOR, value="17 01 06")
    _170107 = UnifiedType(id=5, discriminator=DISCRIMINATOR, value="17 01 07")
    _170201 = UnifiedType(id=6, discriminator=DISCRIMINATOR, value="17 02 01")
    _170202 = UnifiedType(id=7, discriminator=DISCRIMINATOR, value="17 02 02")
    _170203 = UnifiedType(id=8, discriminator=DISCRIMINATOR, value="17 02 03")
    _170204 = UnifiedType(id=9, discriminator=DISCRIMINATOR, value="17 02 04")
    _170301 = UnifiedType(id=10, discriminator=DISCRIMINATOR, value="17 03 01")
    _170302 = UnifiedType(id=11, discriminator=DISCRIMINATOR, value="17 03 02")
    _170303 = UnifiedType(id=12, discriminator=DISCRIMINATOR, value="17 03 03")
    _170401 = UnifiedType(id=13, discriminator=DISCRIMINATOR, value="17 04 01")
    _170402 = UnifiedType(id=14, discriminator=DISCRIMINATOR, value="17 04 02")
    _170403 = UnifiedType(id=15, discriminator=DISCRIMINATOR, value="17 04 03")
    _170404 = UnifiedType(id=16, discriminator=DISCRIMINATOR, value="17 04 04")
    _170405 = UnifiedType(id=17, discriminator=DISCRIMINATOR, value="17 04 05")
    _170406 = UnifiedType(id=18, discriminator=DISCRIMINATOR, value="17 04 06")
    _170407 = UnifiedType(id=19, discriminator=DISCRIMINATOR, value="17 04 07")
    _170409 = UnifiedType(id=20, discriminator=DISCRIMINATOR, value="17 04 09")
    _170410 = UnifiedType(id=21, discriminator=DISCRIMINATOR, value="17 04 10")
    _170411 = UnifiedType(id=22, discriminator=DISCRIMINATOR, value="17 04 11")
    _170503 = UnifiedType(id=23, discriminator=DISCRIMINATOR, value="17 05 03")
    _170504 = UnifiedType(id=24, discriminator=DISCRIMINATOR, value="17 05 04")
    _170505 = UnifiedType(id=25, discriminator=DISCRIMINATOR, value="17 05 05")
    _170506 = UnifiedType(id=26, discriminator=DISCRIMINATOR, value="17 05 06")
    _170507 = UnifiedType(id=27, discriminator=DISCRIMINATOR, value="17 05 07")
    _170508 = UnifiedType(id=28, discriminator=DISCRIMINATOR, value="17 05 08")
    _170601 = UnifiedType(id=29, discriminator=DISCRIMINATOR, value="17 06 01")
    _170603 = UnifiedType(id=30, discriminator=DISCRIMINATOR, value="17 06 03")
    _170604 = UnifiedType(id=31, discriminator=DISCRIMINATOR, value="17 06 04")
    _170605 = UnifiedType(id=32, discriminator=DISCRIMINATOR, value="17 06 05")
    _170801 = UnifiedType(id=33, discriminator=DISCRIMINATOR, value="17 08 01")
    _170802 = UnifiedType(id=34, discriminator=DISCRIMINATOR, value="17 08 02")
    _170901 = UnifiedType(id=35, discriminator=DISCRIMINATOR, value="17 09 01")
    _170902 = UnifiedType(id=36, discriminator=DISCRIMINATOR, value="17 09 02")
    _170903 = UnifiedType(id=37, discriminator=DISCRIMINATOR, value="17 09 03")
    _170904 = UnifiedType(id=38, discriminator=DISCRIMINATOR, value="17 09 04")
    _200136 = UnifiedType(id=39, discriminator=DISCRIMINATOR, value="20 01 36")
    _160504 = UnifiedType(id=40, discriminator=DISCRIMINATOR, value="16 05 04*")
    _020103 = UnifiedType(id=41, discriminator=DISCRIMINATOR, value="02 01 03")
