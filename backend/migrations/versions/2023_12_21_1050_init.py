...
Revision ID: a24b532887c7
Revises: No down revision
Create Date: 2023-12-21 10:50:19.069490
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("health_status_type_id", sa.Integer(), nullable=False),
        sa.Column("reuse_potential_type_id", sa.Integer(), nullable=False),
        sa.Column("waste_code_type_id", sa.Integer(), nullable=False),
        sa.Column("recycling_potential_type_id", sa.Integer(), nullable=False),
