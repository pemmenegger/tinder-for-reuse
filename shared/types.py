...
class MaterialEnum(TypesEnum):
    ...
    METALS = (5, "Metals")
    PLASTER = (6, "Plaster")
    RIGID_PLASTICS_AND_PVC = (7, "Rigid Plastics & PVC")
    GLAZED_WINDOWS = (8, "Glazed Windows")
    GLASS_WOOL = (9, "Glass Wool")
    ROCK_WOOL = (10, "Rock Wool")
    EXPANDED_POLYSTYRENE = (11, "Expanded Polystyrene (EPS)")
    POLYURETHANE = (12, "Polyurethane")
    BIO_BASED_INSULATORS = (13, "Bio-based Insulators")
    BITUMINOUS_MEMBRANES = (14, "Bituminous Membranes")
    NON_PVC_FLOOR_COVERINGS = (15, "Non-PVC Floor Coverings")
    PVC_FLOOR_COVERINGS = (16, "PVC Floor Coverings")
    VINTAGE = (17, "Vintage")
    FLAT_GLASS = (18, "Flat Glass")
    ELECTRICAL_AND_ELECTRONIC_EQUIPMENT = (19, "Electrical and Electronic Equipment")
    FURNITURE_COMPONENTS = (20, "Furniture Components")
